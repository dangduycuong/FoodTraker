...
class MealTableViewController: UITableViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        case "ShowDetail":
            ...
            guard let indenPath = tableView.indexPath(for: selectedMealCell) else {
                fatalError("The selected cell is not being displayed by the table")
            }
            
            let selectedMeal = meals[indenPath.row]
    ...
    private func loadSampleMeals() {
        ...
        guard let meal1 = Meal(name: "Capresese Salad", photo: photo1, rating: 4) else {
            fatalError("Unable to instantiate meal1")
        }
        
        guard let meal2 = Meal(name: "Chicken and Potatoes", photo: photo3, rating: 5) else {
